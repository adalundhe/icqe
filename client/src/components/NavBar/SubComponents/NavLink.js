...
const AuthItem = (props) => <button style={props.isActive ? buttonStyles.buttonSelectedStyle : buttonStyles.buttonStyle}>
                              <NavLink style={linkStyle.normal}  onClick={() => props.action(props.setActive(props.index))} to="/">
                                <Icon name={props.isActive ? props.icon : ''} style={{marginRight: "1em"}} />
                                {props.text}
                              </NavLink>
                            </button>
