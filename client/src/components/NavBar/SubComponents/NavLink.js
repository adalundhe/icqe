...
const AuthItem = (props) => <button style={props.isActive ? buttonStyles.buttonSelectedStyle : buttonStyles.buttonStyle} onClick={() => props.setActive(props.index)}>
                              <Icon name={props.isActive ? props.icon : ''} />
                              <NavLink style={linkStyle.normal}  onClick={() => props.action()} to="/">{props.text}</NavLink>
                            </button>


export {NavItem, AuthItem}
